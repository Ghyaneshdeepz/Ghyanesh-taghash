        ...
        >
          <div className="sm-logo flex items-center select-none pointer-events-auto" aria-label="Logo">
            <img
              src={logoUrl || {taghash}}
              alt="Logo"
              className="xl-logo-img block h-9 w-auto object-contain"
              draggable={false}
              width={180}
              height={40}
            />
...
.sm-scope .staggered-menu-header { position: absolute; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: space-between; padding:0.9em 2em; background: transparent; pointer-events: none; z-index: 20; }
...
@media (max-width: 1024px) { .sm-scope .staggered-menu-panel { width: 120px; left: 0; right: 0; } .sm-scope .staggered-menu-wrapper[data-open] .sm-logo-img { filter: invert(100%); } }
